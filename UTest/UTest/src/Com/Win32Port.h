...
//
public :
   void	OpenWin32Port( const string &port_name,
...
//
    enum { MAX_INPUT_BUFFER_SIZE = 12048 };
    enum { MAX_OUTPUT_BUFFER_SIZE = 12048 };
...
public :
	...
	int MyFlushRxBuffer(void);
	int MyFlushTxBuffer(void);
	int MyFlushRUART(void);
	int MyFlushTUART(void);
//
