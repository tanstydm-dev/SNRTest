...
void Win32Port::OpenWin32Port( const string &port,
...
//
	...
	if (m_hPort==INVALID_HANDLE_VALUE)
	{
        ...
        str = tt;
        // (LPTSTR)(LPCTSTR)(port.c_str());
		m_hPort = CreateFile(str,
    ...
    if ( m_hPort != INVALID_HANDLE_VALUE ) {
        ...
        settings.Dtr = 0;                //Set these five values to their
        settings.Rts = 0;                //default values, the Adjust()
